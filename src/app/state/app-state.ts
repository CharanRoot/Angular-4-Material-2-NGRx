...
import heroListReducer, * as fromHeroList from './reducers/heros.reducer';
import heroReducer, * as fromHero from './reducers/hero.reducer';

export interface AppState {
    heroes: fromHeroList.HerosState;
